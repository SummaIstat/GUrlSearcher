...
logger = logging.getLogger('GUrlSearcherAutoLogger')
...
LOG_FILE_NAME = "GUrlSearcherAuto_" + dateTime + ".log"
...
def loadExternalConfiguration(argv):
    ...
    MIN_SECONDS_SLEEP = int(str(external_settings.get("MIN_SECONDS_SLEEP", "")).rstrip())
    MAX_SECONDS_SLEEP = int(str(external_settings.get("MAX_SECONDS_SLEEP", "")).rstrip())
